...
function publishable_lite_customize_register( $wp_customize ) {
	...
	* Theme Options
    ...
    $wp_customize->add_section(
        'publishable_mag_review',
        array(
            'title' => __('Review Publishable Mag', 'publishable-mag'),
            'priority' => 9999,
            'description' => __('
                                       <a href="https://wordpress.org/support/theme/publishable-mag/reviews/?filter=5" target="_blank" style="display:block;">
                                    <img src="http://admirablethemes.com/wp-content/uploads/2017/10/customizer-info.png">
                                    </a>
                ', 'publishable-mag') 
            )
        );  
    $wp_customize->add_setting('publishable_mag_review[info]', array(
        'sanitize_callback' => 'publishable_mag_no_sanitize',
        'type' => 'info_control',
        'capability' => 'edit_theme_options',
        )
    );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'reviewium_section', array(
        'section' => 'publishable_mag_review',
        'settings' => 'publishable_mag_review[info]',
        'type' => 'themearea',
        'priority' => 109
        ) )
    );  
