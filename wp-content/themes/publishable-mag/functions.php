...
<div class="copyrights">
    ...
    <?php echo '&copy; '.date_i18n(__('Y','publishable-mag')); ?> <?php bloginfo( 'name' ); ?> <?php echo esc_html(' - Design By', 'publishable-mag')?> <a href="<?php echo esc_url('http://admirablethemes.com/')?>"><?php echo esc_html('Admirable Themes', 'publishable-mag')?></a>
